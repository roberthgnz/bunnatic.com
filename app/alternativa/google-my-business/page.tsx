    ...
    <AlternativeLanding
      ...
      copy={{
        es: {
          ...
          urgencyText:
            'Sin web propia, compites en precio y reseñas sin controlar el mensaje.',
          ctaPrimary: 'Crear cuenta gratis',
          ctaSecondary: 'Publicar mi web',
          trustLine:
            'Combina visibilidad en Maps con una página diseñada para convertir.',
          ...
          switchSteps: [
            {
              ...
              description:
                'Partimos de la información existente para acelerar salida a mercado.',
            },
            {
              title: 'Añade ofertas y diferenciales',
              description:
                'Incluyes argumentos comerciales que no caben bien en la ficha.',
            },
            {
              title: 'Conecta CTA de captación',
              description:
                'Recibes contactos en tu canal con más contexto y mejor calidad.',
            },
          ],
        ...
        ca: {
          ...
          urgencyText:
            'Sense web pròpia, competeixes en preu i ressenyes sense controlar el missatge.',
          ctaPrimary: 'Crear compte gratis',
          ctaSecondary: 'Publicar la meva web',
          trustLine:
            'Combina visibilitat a Maps amb una pàgina dissenyada per convertir.',
          ...
          switchSteps: [
            {
              ...
              description:
                'Partim de la informació existent per accelerar sortida a mercat.',
            },
            {
              title: 'Afegeix ofertes i diferencials',
              description:
                'Inclous arguments comercials que no hi caben bé a la fitxa.',
            },
            {
              title: 'Connecta CTA de captació',
              description:
                'Reps contactes al teu canal amb més context i millor qualitat.',
            },
          ],
