    ...
    <BusinessLanding
      ...
      copy={{
        es: {
          ...
          planPrice: "19€/mes",
          planItems: ["Landing optimizada para portfolio", "Formularios por tipo de servicio", "Editor visual para campañas estacionales"],
        ...
        ca: {
          ...
          planPrice: "19€/mes",
          planItems: ["Landing optimitzada per portfolio", "Formularis per tipus de servei", "Editor visual per campanyes estacionals"],
