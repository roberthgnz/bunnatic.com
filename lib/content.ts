export const content = {
  es: {
    ...
    ticker: {
      ...
      text2:
        'Hostal El Pueblo · Carlos R Apuntería · Anni R Veterinaria · Jose · Librería · Joana · Ofimac · Loli D Ofimac',
    },
    howItWorks: {
      title: 'Así de fácil funciona',
      subtitle:
        'Sin técnicos. Sin complicaciones. En 3 pasos tienes tu web lista.',
      steps: [
        {
          number: '1',
          title: 'Busca tu negocio',
          description:
            'El nombre de tu negocio y la IA lo encontrará en Google. Tus datos se rellenan solos.',
          mockup: {
        ...
        },
        {
          ...
          description:
            'En menos de 5 minutos, la IA diseña una web completa con tus textos, servicios y fotos.',
          mockup: {
            title: 'Crea tu web',
            items: [
              'Textos generados',
        ...
        },
        {
          ...
          description:
            'Tu web aparece en Google para tus clientes locales y los contactos llegarán directamente.',
          mockup: {
            tag: 'Web publicada',
    ...
    features: [
      {
        ...
        description:
          'Crea una web completa en segundos usando solo el nombre de tu negocio.',
        icon: 'Sparkles',
        benefits: [
      ...
      },
      {
        ...
        description:
          'Aparece en los primeros resultados cuando los clientes busquen tus servicios en tu zona.',
        icon: 'MapPin',
        benefits: [
      ...
      },
      {
        ...
        description:
          'Edita tu web con un editor visual intuitivo y usa la IA para recibir recomendaciones de contenido.',
        icon: 'MessageSquare',
        benefits: [
      ...
      },
      {
        ...
        description:
          'Convierte visitantes en clientes con formularios optimizados y llamadas a la acción claras.',
        icon: 'Users',
        benefits: [
      ...
      },
      {
        ...
        description:
          'Nos encargamos de toda la parte técnica para que tú te centres en tu negocio.',
        icon: 'Globe',
        benefits: [
    ...
    competitors: [
      {
        ...
        name: 'Facebook Pages',
        description:
          'Una página de Facebook es útil para redes sociales, pero no sustituye a una web profesional. El algoritmo decide quién te ve y no apareces bien en Google.',
        comparison: {
          competitor: {
      ...
      },
      {
        ...
        name: 'Instagram',
        description:
          'Instagram es genial para fotos, pero pésimo para dar información clara (horarios, servicios, precios) o captar clientes a través de Google.',
        comparison: {
          competitor: {
            title: 'Con Instagram',
            items: [
      ...
      },
      {
        ...
        description:
          'Tener una ficha en Google es imprescindible, pero no es suficiente. Una web propia te da credibilidad y te permite explicar por qué eres la mejor opción.',
        comparison: {
          competitor: {
      ...
      },
      {
        ...
        name: 'WordPress',
        description:
          'WordPress es potente pero complejo. Requiere mantenimiento constante, plugins, actualizaciones y conocimientos técnicos.',
        comparison: {
          competitor: {
            title: 'Con WordPress',
            items: [
      ...
      },
      {
        ...
        name: 'Wix',
        description:
          'Wix te hace empezar desde cero con plantillas genéricas. Bunnatic genera tu web con IA usando los datos reales de tu negocio.',
        comparison: {
          competitor: {
            title: 'Con Wix',
            items: [
      ...
      },
      {
        ...
        name: 'Squarespace',
        description:
          'Squarespace es bonito pero caro y pensado para diseñadores. Bunnatic está pensado para dueños de negocios locales.',
        comparison: {
          competitor: {
    ...
    pricing: {
      title: 'Precios',
      subtitle:
        'Simple, flexible y asequible para negocios de cualquier tamaño.',
      ...
      tiers: [
        {
          ...
          period: '/mes',
          description:
            'Para publicar de forma puntual y validar tu presencia local.',
          cta: 'Prueba 14 días',
          features: [
            { title: '1 Web activa', detail: 'Hasta 10 secciones en la web.' },
            {
              title: '15 ediciones/mes',
              detail: 'Incluye cambios de texto e imagen.',
            },
            {
              title: '1 usuario',
              detail: 'Acceso para propietario del negocio.',
            },
          ],
        ...
        },
        {
          ...
          period: '/mes',
          description:
            'Para equipos pequeños que publican y mejoran su web cada semana.',
          cta: 'Prueba 14 días',
          features: [
            {
              title: '3 Webs activas',
              detail: 'Hasta 15 secciones por cada web.',
            },
            {
              title: 'Ediciones ilimitadas',
              detail: 'Asistente de contenido IA sin límites mensuales.',
            },
            {
              title: '3 usuarios',
              detail: 'Colabora con tu equipo de marketing.',
            },
          ],
          addons: ['Sección extra 3€/mes', 'Usuario extra 4€/mes'],
        ...
        },
        {
          ...
          period: '/mes',
          description:
            'Para negocios con varias líneas de servicio o varias sedes.',
          cta: 'Prueba 14 días',
          features: [
            {
              title: '8 Webs activas',
              detail: 'Control centralizado por marca o sede.',
            },
            {
              title: 'Ediciones ilimitadas',
              detail: 'Flujo asistido con IA para equipos.',
            },
            {
              title: '8 usuarios',
              detail: 'Permisos por rol y revisiones internas.',
            },
          ],
        ...
        },
        {
          ...
          period: '/mes',
          description:
            'Para negocios en crecimiento que quieren operar con más autonomía.',
          cta: 'Prueba 14 días',
          features: [
            {
              title: '15 Webs activas',
              detail: 'Gestión multi-sede y multi-marca.',
            },
            {
              title: 'Ediciones ilimitadas',
              detail: 'Automatizaciones y flujos avanzados.',
            },
            {
              title: '15 usuarios',
              detail: 'Gobernanza y auditoría de cambios.',
            },
          ],
    ...
    comparison: {
      ...
      caption:
        'Facebook es útil. (¡úsalo!) pero lo que convierte visitas en clientes.',
    },
    aiDemo: {
      title:
        '¿Necesitas mejorar un texto o una oferta?\nLa IA te recomienda cambios para aplicarlos en tu editor visual.',
      ...
      chat: [
        ...
        {
          type: 'system',
          text: 'Recomendación: añade un bloque de oferta con CTA a WhatsApp.',
        },
        {
          type: 'user',
          text: '¿Qué titular me recomiendas para convertir más?',
        },
        {
          type: 'system',
          text: 'Propuesta: "Promo de julio: reserva hoy y ahorra un 20%".',
        },
        { type: 'user', text: '¿Dónde lo coloco en la página?' },
        {
          type: 'system',
          text: 'Sugerencia: justo debajo del bloque de servicios para aumentar clics.',
        },
      ],
      caption:
        'Editas tu web con un editor visual y usas la IA para optimizar textos, ofertas y estructura.',
    },
    faq: {
      ...
      questions: [
        {
          ...
          a: 'No, nuestra IA se encarga de todo el proceso técnico por ti.',
        },
        {
          q: '¿Qué pasa si el cliente cancela?',
          a: 'Puedes cancelar tu suscripción en cualquier momento sin penalizaciones.',
        },
        {
          q: '¿Mi web aparecerá en Google?',
          a: 'Sí, todas nuestras webs están optimizadas para SEO y aparecerán en los resultados de búsqueda.',
        },
        {
          q: '¿Puedo usar mi propio dominio (.com)?',
          a: 'Sí, puedes conectar tu propio dominio personalizado fácilmente.',
        },
        {
          q: '¿Qué pasa si no me gusta cómo queda?',
          a: 'Puedes regenerar el diseño tantas veces como quieras hasta que estés satisfecho.',
        },
        {
          q: '¿Funciona para mi tipo de negocio?',
          a: 'Bunnatic está diseñado para adaptarse a cualquier tipo de negocio local, desde restaurantes hasta clínicas.',
        },
      ],
    },
    finalCta: {
  ...
  ca: {
    ...
    ticker: {
      ...
      text2:
        'Hostal El Poble · Carles R Apunteria · Anni R Veterinària · Josep · Llibreria · Joana · Ofimac · Loli D Ofimac',
    },
    howItWorks: {
      title: 'Així de fàcil funciona',
      subtitle:
        'Sense tècnics. Sense complicacions. En 3 passos tens la teva web llesta.',
      steps: [
        {
          number: '1',
          title: 'Busca el teu negoci',
          description:
            "El nom del teu negoci i la IA el trobarà a Google. Les teves dades s'omplen soles.",
          mockup: {
        ...
        },
        {
          ...
          description:
            'En menys de 5 minuts, la IA dissenya una web completa amb els teus textos, serveis i fotos.',
          mockup: {
        ...
        },
        {
          ...
          description:
            'La teva web apareix a Google per als teus clients locals i els contactes arribaran directament.',
          mockup: {
            tag: 'Web publicada',
    ...
    features: [
      {
        ...
        description:
          'Crea una web completa en segons utilitzant només el nom del teu negoci.',
        icon: 'Sparkles',
        benefits: [
      ...
      },
      {
        ...
        description:
          'Apareix en els primers resultats quan els clients busquin els teus serveis a la teva zona.',
        icon: 'MapPin',
        benefits: [
      ...
      },
      {
        ...
        description:
          'Edita la teva web amb un editor visual intuïtiu i usa la IA per rebre recomanacions de contingut.',
        icon: 'MessageSquare',
        benefits: [
      ...
      },
      {
        ...
        description:
          "Converteix visitants en clients amb formularis optimitzats i crides a l'acció clares.",
        icon: 'Users',
        benefits: [
      ...
      },
      {
        ...
        description:
          'Ens encarreguem de tota la part tècnica perquè tu et centris en el teu negoci.',
        icon: 'Globe',
        benefits: [
    ...
    competitors: [
      {
        ...
        name: 'Facebook Pages',
        description:
          "Una pàgina de Facebook és útil per a xarxes socials, però no substitueix una web professional. L'algoritme decideix qui et veu i no apareixes bé a Google.",
        comparison: {
          competitor: {
      ...
      },
      {
        ...
        name: 'Instagram',
        description:
          'Instagram és genial per a fotos, però pèssim per donar informació clara (horaris, serveis, preus) o captar clients a través de Google.',
        comparison: {
          competitor: {
            title: 'Amb Instagram',
            items: [
      ...
      },
      {
        ...
        name: 'Google My Business',
        description:
          'Tenir una fitxa a Google és imprescindible, però no és suficient. Una web pròpia et dóna credibilitat i et permet explicar per què ets la millor opció.',
        comparison: {
          competitor: {
      ...
      },
      {
        ...
        name: 'WordPress',
        description:
          'WordPress és potent però complex. Requereix manteniment constant, plugins, actualitzacions i coneixements tècnics.',
        comparison: {
          competitor: {
            title: 'Amb WordPress',
            items: [
      ...
      },
      {
        ...
        name: 'Wix',
        description:
          'Wix et fa començar des de zero amb plantilles genèriques. Bunnatic genera la teva web amb IA utilitzant les dades reals del teu negoci.',
        comparison: {
          competitor: {
            title: 'Amb Wix',
            items: [
      ...
      },
      {
        ...
        name: 'Squarespace',
        description:
          'Squarespace és bonic però car i pensat per a dissenyadors. Bunnatic està pensat per a propietaris de negocis locals.',
        comparison: {
          competitor: {
    ...
    pricing: {
      title: 'Preus',
      subtitle:
        'Simple, flexible i assequible per a negocis de qualsevol mida.',
      ...
      tiers: [
        {
          ...
          period: '/mes',
          description:
            'Per publicar de manera puntual i validar la teva presencia local.',
          cta: 'Prova 14 dies',
          features: [
            { title: '1 Web activa', detail: 'Fins a 10 seccions a la web.' },
            {
              title: '15 edicions/mes',
              detail: 'Inclou canvis de text i imatge.',
            },
            {
              title: '1 usuari',
              detail: 'Accés per al propietari del negoci.',
            },
          ],
        ...
        },
        {
          ...
          period: '/mes',
          description:
            'Per a equips petits que publiquen i milloren la web cada setmana.',
          cta: 'Prova 14 dies',
          features: [
            {
              title: '3 Webs actives',
              detail: 'Fins a 15 seccions per cada web.',
            },
            {
              title: 'Edicions il·limitades',
              detail: 'Assistent de contingut IA sense límits mensuals.',
            },
            {
              title: '3 usuaris',
              detail: "Col·labora amb l'equip de màrqueting.",
            },
          ],
          addons: ['Secció extra 3€/mes', 'Usuari extra 4€/mes'],
        ...
        },
        {
          ...
          period: '/mes',
          description:
            'Per a negocis amb diverses línies de servei o diverses seus.',
          cta: 'Prova 14 dies',
          features: [
            {
              title: '8 Webs actives',
              detail: 'Control centralitzat per marca o seu.',
            },
            {
              title: 'Edicions il·limitades',
              detail: 'Flux assistit amb IA per equips.',
            },
            {
              title: '8 usuaris',
              detail: 'Permisos per rol i revisions internes.',
            },
          ],
        ...
        },
        {
          ...
          period: '/mes',
          description:
            'Per a negocis en creixement que volen operar amb més autonomia.',
          cta: 'Prova 14 dies',
          features: [
            {
              title: '15 Webs actives',
              detail: 'Gestió multi-seu i multi-marca.',
            },
            {
              title: 'Edicions il·limitades',
              detail: 'Automatitzacions i fluxos avançats.',
            },
            {
              title: '15 usuaris',
              detail: 'Governança i auditoria de canvis.',
            },
          ],
    ...
    comparison: {
      title:
        'La teva pàgina de Facebook està bé. Però\nGoogle no la mostra quan algú busca\nel teu negoci.',
      cards: {
        facebook: {
      ...
      caption:
        'Facebook és útil. (fes-lo servir!) però el que converteix visites en clients és una web.',
    },
    aiDemo: {
      title:
        'Necessites millorar un text o una oferta?\nLa IA et recomana canvis per aplicar-los al teu editor visual.',
      ...
      chat: [
        ...
        {
          type: 'system',
          text: "Recomanació: afegeix un bloc d'oferta amb CTA a WhatsApp.",
        },
        { type: 'user', text: 'Quin titular em recomanes per convertir més?' },
        {
          type: 'system',
          text: 'Proposta: "Promo de juliol: reserva avui i estalvia un 20%".',
        },
        { type: 'user', text: 'On ho col·loco a la pàgina?' },
        {
          type: 'system',
          text: 'Suggeriment: just sota el bloc de serveis per augmentar clics.',
        },
      ],
      caption:
        'Edits la teva web amb un editor visual i uses la IA per optimitzar textos, ofertes i estructura.',
    },
    faq: {
      title: 'Preguntes freqüents',
      questions: [
        {
          q: "Necessito saber d'informàtica?",
          a: "No, la nostra IA s'encarrega de tot el procés tècnic per tu.",
        },
        {
          q: 'Què passa si el client cancel·la?',
          a: 'Pots cancel·lar la teva subscripció en qualsevol moment sense penalitzacions.',
        },
        {
          q: 'La meva web apareixerà a Google?',
          a: 'Sí, totes les nostres webs estan optimitzades per a SEO i apareixeran als resultats de cerca.',
        },
        {
          q: 'Puc utilitzar el meu propi domini (.com)?',
          a: 'Sí, pots connectar el teu propi domini personalitzat fàcilment.',
        },
        {
          q: "Què passa si no m'agrada com queda?",
          a: 'Pots regenerar el disseny tantes vegades com vulguis fins que estiguis satisfet.',
        },
        {
          q: 'Funciona per al meu tipus de negoci?',
          a: 'Bunnatic està dissenyat per adaptar-se a qualsevol tipus de negoci local, des de restaurants fins a clíniques.',
        },
      ],
    },
    finalCta: {
