...
const rawBusinessLandingEntries: Array<
  Omit<BusinessLandingEntry, 'slug' | 'slugs'>
> = [
  {
    ...
    copy: {
      ...
      ca: {
        ...
        urgencyText:
          'Sense una proposta clara, els pacients comparen només per preu.',
        trustLine:
          'Web professional amb proves de confiança i contacte immediat.',
        ...
        process: [
          {
            title: 'Ordena la teva oferta clínica',
            description: 'Implants, ortodòncia i estètica amb missatges clars.',
          },
          {
            title: 'Activa credencials i confiança',
            description: 'Ressenyes i arguments que redueixen objeccions.',
          },
          {
            title: 'Optimitza el contacte',
            description: 'CTA directe per agendar visita inicial.',
          },
        ],
        ...
        testimonials: [
          {
            quote:
              'Vam millorar ràtio de consulta a cita després de reorganitzar tractaments a la web.',
            author: 'Marta H.',
            role: 'Clínica dental',
          },
          {
            quote: 'Rebem més contactes qualificats des de Google local.',
            author: 'Javier L.',
            role: 'Centre odontològic',
          },
        ],
        ...
        finalSubtitle:
          "Registra't i activa la teva web dental enfocada a captació.",
  ...
  },
  {
    ...
    copy: {
      ...
      ca: {
        ...
        urgencyText:
          'Sense una oferta ben presentada, perds cites davant competència millor posicionada.',
        ...
        process: [
          {
            title: 'Defineix tractaments clau',
            description: 'Destaquem serveis amb més conversió i marge.',
          },
          {
            title: 'Activa missatges de confiança',
            description:
              'Inclou testimonis i arguments que tanquen objeccions.',
          },
          {
            title: "Capta contactes a l'instant",
            description: 'Formulari i WhatsApp per reservar en calent.',
          },
        ],
        ...
        testimonials: [
          {
            quote:
              'Amb una pàgina millor estructurada van pujar les reserves de bo.',
            author: 'Paula S.',
            role: 'Centre estètic',
          },
          {
            quote: 'Ara els clients arriben amb el tractament decidit.',
            author: 'Andrea N.',
            role: 'Clínica dermoestètica',
          },
        ],
        ...
        finalSubtitle:
          "Registra't i publica una pàgina pensada per vendre tractaments.",
        ctaPrimary: 'Crear compte gratis',
        ctaSecondary: 'Provar demo',
      },
    },
  ...
  },
  {
    ...
    copy: {
      ...
      ca: {
        ...
        urgencyText:
          'Sense una oferta clara online, el lead es refreda en minuts.',
        trustLine:
          'Més altes amb CTAs de prova, contacte immediat i proposta de valor visible.',
        ...
        process: [
          {
            title: 'Defineix plans i promeses',
            description: 'Mostrem què aconsegueix cada tipus de client amb tu.',
          },
          {
            title: 'Configura lead magnet',
            description: 'Prova gratis o sessió inicial com a CTA principal.',
          },
          {
            title: 'Mesura i millora',
            description: 'Itera missatges segons quin pla converteix més.',
          },
        ],
        ...
        testimonials: [
          {
            quote:
              'Vam duplicar proves setmanals amb una landing clara per objectius.',
            author: 'Ruth M.',
            role: "Box d'entrenament",
          },
          {
            quote: 'La web ens filtra millor i arriben leads més decidits.',
            author: 'Héctor A.',
            role: 'Gimnàs de barri',
          },
        ],
      ...
      ca: {
        ...
        process: [
          ...
          },
          {
            ...
            description: 'Ajusta proposta segons tipus de lead que més tanca.',
          },
        ],
  ...
  },
  {
    ...
    copy: {
      ...
      ca: {
        ...
        urgencyText:
          'Cada client que no troba preu o horari clar marxa a una altra perruqueria.',
        trustLine:
          'Web mòbil + WhatsApp + formulari per omplir agenda amb menys fricció.',
        ...
        process: [
          {
            title: 'Configura els teus serveis',
            description: 'Talls, color i tractaments amb enfocament comercial.',
          },
          {
            title: 'Publica CTAs directes',
            description: 'Botons clars de trucada, WhatsApp i reserva.',
          },
          {
            title: 'Ajusta segons demanda',
            description:
              'Edita ofertes per temporada sense dependre de tercers.',
          },
        ],
        ...
        testimonials: [
          {
            quote:
              'Vam pujar reserves de color explicant millor els packs a la web.',
            author: 'Clara V.',
            role: 'Perruqueria unisex',
          },
          {
            quote:
              'Amb un sol enllaç vam passar de missatges solts a cites clares.',
            author: 'Marc R.',
            role: 'Barberia',
          },
        ],
        ...
        finalSubtitle:
          "Crea el teu compte i comença a captar cites des d'avui.",
        ctaPrimary: 'Crear compte gratis',
        ctaSecondary: 'Provar demo',
      },
    },
  },
  {
    ...
    copy: {
      ...
      ca: {
        ...
        urgencyText:
          'Si el client no troba menú o disponibilitat en segons, abandona.',
        trustLine:
          "La teva web com a canal de captació propi, més enllà d'apps de tercers.",
        ...
        process: [
          {
            title: 'Puja menú i proposta',
            description: 'Destaquem plats estrella i diferencials del local.',
          },
          {
            title: 'Activa reserves/contacte',
            description: 'Botons visibles per reservar o demanar informació.',
          },
          {
            title: 'Optimitza per servei',
            description: 'Ajusta campanyes per migdia, nits o esdeveniments.',
          },
        ],
        ...
        testimonials: [
          {
            quote:
              'Vam passar trànsit de Google a reserves directes amb millor marge.',
            author: 'Nerea T.',
            role: 'Restaurant mediterrani',
          },
          {
            quote:
              'La gent arriba més informada i amb menys dubtes sobre carta i horaris.',
            author: 'Joan P.',
            role: 'Braseria local',
          },
        ],
        ...
        finalSubtitle:
          'Activa la teva web i comença a captar reserves directes.',
        ctaPrimary: 'Crear compte gratis',
        ctaSecondary: 'Publicar la meva web',
      },
    },
      ...
      ca: {
        ...
        process: [
          ...
          },
          {
            ...
            description: 'Campanyes per ITV, vacances o manteniment preventiu.',
          },
        ],
        proofTitle: 'Tallers que ja han millorat captació',
        testimonials: [
          {
            quote: 'Van pujar trucades la primera setmana amb la nova pàgina.',
            author: 'Rubén G.',
            role: 'Taller multimarca',
          },
          {
  ...
  },
  {
    ...
    copy: {
      ...
      ca: {
        ...
        urgencyText:
          'En veterinària, cada minut sense informació clara pot costar una visita.',
        trustLine:
          'Canal directe per primera cita, revisions i atenció urgent.',
        ...
        process: [
          {
            title: 'Organitza serveis i especialitats',
            description: 'Vacunes, revisions i urgències ben visibles.',
          },
          {
            title: 'Destaca contacte urgent',
            description: 'Botons directes per respondre ràpid.',
          },
          {
            title: 'Optimitza per zona',
            description: "Apareix en cerques locals d'alta intenció.",
          },
        ],
        ...
        testimonials: [
          {
            quote:
              'Vam millorar resposta en urgències centralitzant contacte a la web.',
            author: 'Elena D.',
            role: 'Clínica veterinària',
          },
          {
            quote: 'Van pujar cites de revisió amb una oferta més clara.',
            author: 'Toni M.',
            role: 'Hospital veterinari local',
          },
        ],
        ...
        finalSubtitle:
          'Crea el teu compte i activa una web clara per captar més cites.',
        ctaPrimary: 'Crear compte gratis',
        ctaSecondary: 'Veure demo',
      },
    },
