    ...
    <BusinessLanding
      ...
      copy={{
        es: {
          ...
          planPrice: "19€/mes",
          planItems: ["CTA de llamada directa", "SEO local técnico", "Editor visual para campañas por temporada"],
        ...
        ca: {
          ...
          planPrice: "19€/mes",
          planItems: ["CTA de trucada directa", "SEO local tècnic", "Editor visual per campanyes de temporada"],
