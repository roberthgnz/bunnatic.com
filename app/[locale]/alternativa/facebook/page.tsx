    ...
    <AlternativeLanding
      ...
      copy={{
        es: {
          ...
          title: "La alternativa a Facebook Pages para captar clientes de verdad",
          subtitle:
          ...
          switchSteps: [
            {
              ...
              description: "La IA crea una base lista con tus servicios y propuesta comercial.",
            },
            {
              title: "Activa captación directa",
              description: "Configuras formularios y botones para recibir oportunidades reales.",
            },
            {
              title: "Mantén Facebook como apoyo",
              description: "Usas redes para visibilidad y la web para cerrar registros y ventas.",
            },
          ],
        ...
        ca: {
          ...
          urgencyText: "Cada canvi d'algoritme pot retallar el teu abast sense avís.",
          ctaPrimary: "Crear compte gratis",
          ctaSecondary: "Provar demo ara",
          trustLine: "Web pròpia + SEO local + CTAs directes per transformar visites en registres.",
          ...
          switchSteps: [
            {
              ...
              description: "La IA crea una base llesta amb serveis i proposta comercial.",
            },
            {
              title: "Activa captació directa",
              description: "Configures formularis i botons per rebre oportunitats reals.",
            },
            {
              title: "Mantén Facebook com a suport",
              description: "Uses xarxes per visibilitat i la web per tancar registres i vendes.",
            },
          ],
