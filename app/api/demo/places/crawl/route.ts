...
function getExtractionPayload(pages: Document[]): ExtractionPayload {
  for (const page of pages) {
    ...
    if (fromJson) {
      return {
        name: pickFirstString(fromJson.name, fromJson.businessName, fromJson.companyName) ?? undefined,
        description: pickFirstString(fromJson.description, fromJson.summary, fromJson.about) ?? undefined,
        about: pickFirstString(fromJson.about, fromJson.description) ?? undefined,
        address: pickFirstString(fromJson.address, fromJson.location) ?? undefined,
        phone: pickFirstString(fromJson.phone, fromJson.phoneNumber, fromJson.telephone) ?? undefined,
        ...
        reviewCount: pickFirstNumber(fromJson.reviewCount, fromJson.user_ratings_total) ?? undefined,
      };
    }
  }
