    ...
    <FeatureLanding
      ...
      copy={{
        es: {
          ...
          urgencyText:
            'Web desactualizada = clientes que dudan y no contactan.',
          trustLine:
            'Cambios inmediatos, sin tickets técnicos y sin romper el diseño.',
        ...
        ca: {
          ...
          urgencyText:
            'Web desactualitzada = clients que dubten i no contacten.',
          trustLine:
            'Canvis immediats, sense tickets tècnics i sense trencar el disseny.',
