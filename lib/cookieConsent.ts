...
export function getCookieConsent(cookieSource?: string): CookieConsentState | null {
...
export function saveCookieConsent(analytics: boolean): CookieConsentState | null {
  if (typeof document === 'undefined') {
    return null;
  }
