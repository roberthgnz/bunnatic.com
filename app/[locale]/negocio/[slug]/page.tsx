...
import {getBusinessLandingBySlug, getBusinessSlugByLocale} from "@/lib/businessLandingData";
...
export async function generateMetadata({ params }: BusinessParams): Promise<Metadata> {
