...
const createPageContent = {
  ...
  ca: {
    crear: {
      ...
      subtitle:
        'Connectem amb Google My Business per extreure la teva informació i crear la teva web en segons.',
      searchPlaceholder:
        'Ex: Pizzeria Napoli, Barcelona o https://el-teu-negoci.com',
      searchButton: 'Cercar',
      resultsTitle: 'Resultats',
      analyzingTitle: 'La IA està analitzant el teu negoci...',
      analyzingSubtitle:
        'Extraient informació de Google, llegint ressenyes i generant textos optimitzats per a SEO.',
      ...
      generatedProposal:
        'Hem generat una proposta de disseny basada en el teu perfil de Google.',
      ...
      aboutUsText:
        'Basat en les excel·lents ressenyes dels nostres clients ({rating} estrelles), ens enorgulleix oferir el millor servei a {city}.',
      ...
      minimalistNote:
        'Aquesta és una versió minimalista del teu web. La versió final pot incloure més seccions, disseny avançat, SEO tècnic i automatitzacions.',
      publishedTitle: 'La teva web està publicada!',
      publishedSubtitle:
        'El lloc web per a {name} ja està online i llest per rebre clients.',
      ...
      noResultsSubtitle:
        'Prova amb el nom exacte del negoci i la ciutat per millorar els resultats.',
    },
  },
} as const
...
function CreateWebContent() {
  ...
  const aboutText =
    ...
    t.crear.aboutUsText
      ...
      .replace(
        '{city}',
        placeDetails?.formatted_address?.split(',')?.[1]?.trim() ||
          (language === 'es' ? 'la ciudad' : 'la ciutat')
      )
