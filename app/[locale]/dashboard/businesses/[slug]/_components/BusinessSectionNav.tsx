  ...
  const groups: NavGroup[] = [
    {
      ...
      items: [
        ...
        },
        {
          key: 'overview',
          href: `${base}/overview`,
          label: isCatalan ? 'Resum' : 'Resumen',
          icon: LayoutGrid,
        },
        {
          key: 'services',
          href: `${base}/services`,
          label: isCatalan ? 'Serveis' : 'Servicios',
          icon: Briefcase,
        },
        {
          key: 'hours',
          href: `${base}/hours`,
          label: isCatalan ? 'Horari' : 'Horario',
          icon: Clock,
        },
      ],
    },
      ...
      items: [
        {
          key: 'leads',
          href: `${base}/leads`,
          label: isCatalan ? 'Missatges' : 'Mensajes',
          icon: MessageSquare,
        },
        {
          key: 'analytics',
        ...
        },
        {
          key: 'calendar',
          href: `${base}/calendar`,
          label: isCatalan ? 'Calendari' : 'Calendario',
          icon: CalendarIcon,
        },
      ],
    },
