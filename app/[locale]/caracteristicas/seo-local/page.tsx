    ...
    <FeatureLanding
      ...
      copy={{
        es: {
          ...
          urgencyText: "Si no sales en búsquedas locales, tus competidores se quedan con esos clientes.",
          trustLine: "SEO técnico + estructura comercial + velocidad de carga para mejorar conversión.",
        ...
        ca: {
          ...
          urgencyText: "Si no surts a cerques locals, la competència es queda aquests clients.",
          trustLine: "SEO tècnic + estructura comercial + velocitat de càrrega per millorar conversió.",
