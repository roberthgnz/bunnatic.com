    ...
    <BusinessLanding
      ...
      copy={{
        es: {
          ...
          planPrice: "19€/mes",
          planItems: ["Edición instantánea de horarios", "Contacto directo integrado", "SEO local para búsquedas urgentes"],
        ...
        ca: {
          ...
          planPrice: "19€/mes",
          planItems: ["Edició instantània d'horaris", "Contacte directe integrat", "SEO local per cerques urgents"],
