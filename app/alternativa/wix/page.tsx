    ...
    <AlternativeLanding
      ...
      copy={{
        es: {
          ...
          title:
            'La alternativa a Wix para lanzar más rápido y convertir mejor',
          subtitle:
          ...
          urgencyText:
            'Si tardas en publicar, también tardas en generar oportunidades.',
          ctaPrimary: 'Crear cuenta gratis',
          ctaSecondary: 'Probar demo',
          trustLine:
            'IA + estructura comercial para pasar de idea a web operativa en minutos.',
          ...
          switchSteps: [
            {
              ...
              description:
                'Indicamos tipo de cliente y acción que quieres priorizar.',
            },
            {
              title: 'Genera y ajusta propuesta',
              description:
                'Partes de una base sólida y haces ajustes mínimos para publicar.',
            },
            {
              title: 'Activa captación',
              description:
                'Empiezas a recibir contactos con formularios y CTAs listos.',
            },
          ],
        ...
        ca: {
          ...
          urgencyText:
            'Si trigues a publicar, també trigues a generar oportunitats.',
          ctaPrimary: 'Crear compte gratis',
          ctaSecondary: 'Provar demo ara',
          trustLine:
            "IA + estructura comercial per passar d'idea a web operativa en minuts.",
          ...
          switchSteps: [
            {
              ...
              description:
                'Indiquem tipus de client i acció que vols prioritzar.',
            },
            {
              title: 'Genera i ajusta proposta',
              description:
                "Parteixes d'una base sòlida i fas ajustos mínims per publicar.",
            },
            {
              title: 'Activa captació',
              description:
                'Comences a rebre contactes amb formularis i CTAs llestos.',
            },
          ],
