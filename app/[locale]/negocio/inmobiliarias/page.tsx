    ...
    <BusinessLanding
      ...
      copy={{
        es: {
          ...
          planPrice: "19€/mes",
          planItems: ["Formularios segmentados por lead", "SEO local por zona", "Editor visual para nuevas campañas"],
        ...
        ca: {
          ...
          planPrice: "19€/mes",
          planItems: ["Formularis segmentats per lead", "SEO local per zona", "Editor visual per noves campanyes"],
