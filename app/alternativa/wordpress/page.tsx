    ...
    <AlternativeLanding
      ...
      copy={{
        es: {
          ...
          urgencyText:
            'Cada hora en tareas técnicas es una hora menos vendiendo.',
          ctaPrimary: 'Crear cuenta gratis',
          ctaSecondary: 'Ver demo guiada',
          trustLine:
            'Publica rápido con IA y gestiona cambios sin tocar plugins ni código.',
          ...
          switchSteps: [
            {
              ...
              description:
                'Priorizamos páginas que generan contacto y no solo presencia.',
            },
            {
              title: 'Genera estructura de captación',
              description:
                'La IA crea textos y bloques pensados para conversión desde el inicio.',
            },
            {
              title: 'Publica y optimiza',
              description:
                'Lanzas rápido y ajustas mensajes según respuesta del mercado.',
            },
          ],
        ...
        ca: {
          ...
          urgencyText:
            'Cada hora en tasques tècniques és una hora menys venent.',
          ctaPrimary: 'Crear compte gratis',
          ctaSecondary: 'Veure demo guiada',
          trustLine:
            'Publica ràpid amb IA i gestiona canvis sense tocar plugins ni codi.',
          ...
          switchSteps: [
            {
              ...
              description:
                'Prioritzem pàgines que generen contacte i no només presència.',
            },
            {
              title: 'Genera estructura de captació',
              description:
                "La IA crea textos i blocs pensats per conversió des de l'inici.",
            },
            {
              title: 'Publica i optimitza',
              description:
                'Llança ràpid i ajusta missatges segons resposta del mercat.',
            },
          ],
