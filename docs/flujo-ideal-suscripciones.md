...
Hoy el funnel mezcla tres intenciones distintas (`ver demo`, `crear cuenta`, `comprar plan`) en rutas y CTAs diferentes. Eso genera saltos de contexto, perdida de idioma y perdida de intencion (plan elegido, origen de campa�a, etc.).
...
Si se aplica este redise�o de flujo, deberias ver mejora en:
