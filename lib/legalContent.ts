    ...
    "politica-cookies": {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: ["Actualmente en Bunnatic utilizamos o podemos utilizar las siguientes categorias de cookies:"],
          bullets: [
      ...
      sections: [
        {
          ...
          paragraphs: ["Podem tractar les dades seguents quan utilitzes Bunnatic:"],
          bullets: [
    ...
    "politica-cookies": {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: ["Actualment a Bunnatic utilitzem o podem utilitzar les categories de cookies seguents:"],
          bullets: [
